...
class GatherProxy(object):
    ...
    def getelite(self, pages, uptime=70, fast=True):
        ...
        for i in range(1, pages + 1):
            ...
            for item in self.pre.findall(r.text):
                ...
                if int(data['PROXY_TIME']) <= 150 and str(data['PROXY_COUNTRY']) == 'China':
                    try:
...
class ProxyPool(object):
    ...
    def updateGatherProxy(self, pages=20, uptime=70, fast=True):
